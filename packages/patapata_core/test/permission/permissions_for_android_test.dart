...
void main() {
  ...
  test('trackingRequested for Android', () async {
    late App app;
  ...
  test('notificationsRequested for Android', () async {
    late App app;
  ...
  test('requestTracking for Android (notSupported)', () async {
    late App app;
  ...
  test('requestNotifications for Android (true)', () async {
    late App app;
  ...
  test('requestNotifications for Android (false)', () async {
    late App app;
  ...
  test('notificationsStream for Android', () async {
    late App app;
